...
pred test {
some c1: Conviction, c2: Conviction, c3: Conviction, c4: Conviction, c5: Conviction, exp: Expungement | 
((c2 != c1)) and 
((c3 != c1) and (c3 != c2)) and 
((c4 != c1) and (c4 != c2) and (c4 != c3)) and 
((c5 != c1) and (c5 != c2) and (c5 != c3) and (c5 != c4)) and 
((c2 in Felony) and (not c2 in Assaultive) and (not c2 in TenYearFelony)) and 
((c3 in Felony) and (not c3 in Assaultive) and (not c3 in TenYearFelony)) and 
((c4 in Misdemeanor) and (not c4 in Assaultive) and (not c4 in OWI)) and 
(c1.date in d2005.*ordering/next and d2025 in c1.date.*ordering/next) and 
(c2.date = d2007) and 
(c3.date in d2010.*ordering/next and d2011 in c3.date.*ordering/next) and 
(c4.date in d2014.*ordering/next and d2017 in c4.date.*ordering/next) and 
(c5.date = d2019) and 
exp.date = d2025 and
not c3 in exp.con
}
