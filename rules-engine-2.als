...
fact {
	...
	no setAside
	-- Initialize unexpungable to be empty
...
pred cannotBeExpunged[c: Conviction]{
	c in unexpungable'
}
...
pred show {
	...
	some unexpungable
	--some c1, c2: Conviction | c1 in unexpungable and c2 in unexpungable
	--always some Conviction - setAside
}

run show for 3 Misdemeanor, 3 Felony
